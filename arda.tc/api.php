...
function sendFormSummaryByEmail(array $formConfig, array $data, array $attachments)
{
    ...
    $destinationEmail = $formConfig['form']['emailTo'] ? $formConfig['form']['emailTo'] : 'rdcom1@arda.tc';
...
// PDF listesi endpoint'i (en başa alındı)
if (isset($_GET['action']) && $_GET['action'] === 'list_pdfs') {
